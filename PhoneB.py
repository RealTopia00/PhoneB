...
def infinite(pn, dl, ch, max):
    ...
    while True:
        ...
        count_inf += 1
        # os.system('echo RealTopia >> count.xxx')
        time.sleep(float(dl))
        if (count_inf > maxlim):
            exit()
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "90":
                print('Sorry All APIs Have Expired Please Update PhoneB')
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail To ohaik429@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        ...
        print("              This Bomber Was Created By RealTopia !!                ")
        print("==================================================================")
        try:
...
def update():
    ...
    for fl in stuff_to_update:
        dat = urllib.request.urlopen(
            "https://raw.githubusercontent.com/RealTopia00/PhoneB/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen(
    "https://raw.githubusercontent.com/RealTopia00/PhoneB/master/.version").read().decode('utf-8')
verl = ''
try:
...
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/RealTopia00/PhoneB/master/.notify").read().decode('utf-8')
...
if nm == 0:
    ...
    if nt <= 0 or nt >= 30:
        print('\tPhoneB Shows Better Result in 10 to 25 Threads\n\t\tStill Continuing....')
